...
# python train_scratch.py --save_path experiments/TinyImageNet/baseline/resnet50
# python train_scratch.py --save_path ./experiments/CIFAR100/baseline/resnet50
    # ************************** random seed **************************
seed = 0
...
if __name__ == "__main__":
    ...
    if params.model_name == 'resnet18':
        ...
        model = vgg13(num_classes=num_class)
    elif params.model_name == 'vgg8':
        model = vgg8(num_classes=num_class)
