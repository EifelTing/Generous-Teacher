...
parser.add_argument('--save_path', default='experiments/CIFAR10/generous_teacher/resnet18_self', type=str)
parser.add_argument('--resume', default=None, type=str)
parser.add_argument('--Tn', default=1.0, type=float)
...
# ************************** training function **************************
def train_epoch_kd_adv(model, model_ad, optim, data_loader, epoch, params,args):
    model.train()
    model_ad.eval()
...
def train_and_eval_kd_adv(model, model_ad, optim, train_loader, dev_loader, params,args):
    best_val_acc = -1
    best_epo = -1
    ...
    for epoch in range(params.num_epochs):
        ...
        train_loss, train_tloss, train_aloss = train_epoch_kd_adv(model, model_ad, optim,
                                                                  train_loader, epoch, params,args)
...
if __name__ == "__main__":
    ...
    # ************************** train and evaluate **************************
    train_and_eval_kd_adv(model, adversarial_model, optimizer, trainloader, devloader, params,args)
